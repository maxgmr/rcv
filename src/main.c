...
static struct argp_option options[] = {
    {"dec", 'i', 0, 0, "(Default) output as a signed decimal number (radix 10)",
     0},
    {"dec", 'u', 0, 0, "Output as an unsigned decimal number (radix 10)", 0},
    {"hex", 'x', 0, 0, "Output as a hexadecimal number (radix 16)", 0},
    {"oct", 'o', 0, 0, "Output as an octal number (radix 8)", 0},
    {"bin", 'b', 0, 0, "Output as a binary number (radix 2)", 0},
    {"no-newline", 'n', 0, 0, "Omit the line feed at the end of the output", 0},
    {"no-prefix", 'p', 0, 0,
     "Omit the prefix for hexadecimal, octal, and binary output", 0},
    {"coct-prefix", 'c', 0, 0,
     "Use a C-style octal prefix (leading 0) instead of a\
